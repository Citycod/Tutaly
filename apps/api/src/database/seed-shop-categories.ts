...
const categoriesData = {
  ...
  'Business Security & Storage': ['Office Safes', 'Lock Boxes'],
  'Learning Materials': ['Books', 'Study Guides', 'Training Manuals'],
  'Professional Bags': ['Laptop Bags', 'Briefcases', 'Backpacks'],
  ...
  'Other / Uncategorized': ['Miscellaneous Services', 'Miscellaneous Products'],
};
