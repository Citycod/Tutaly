...
export default function CreateProductPage() {
  ...
  return (
    <div className="p-8 pb-16 max-w-3xl">
      <Link href="/employer/shop" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-teal-600 mb-8 font-medium">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg border border-gray-200 px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-teal-500 bg-white"
                required
              >
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    className="w-24 rounded-lg border border-gray-200 px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-teal-500 bg-white font-bold"
                  >
                  ...
                  <input
                    ...
                    className="flex-1 rounded-lg border border-gray-200 px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-teal-500"
                    required
                    min={1}
                    placeholder="0.00"
                  />
