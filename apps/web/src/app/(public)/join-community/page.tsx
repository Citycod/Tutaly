    ...
    <div className="min-h-screen bg-c100 pt-20 pb-16">
      ...
      <section className="bg-navy py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="mt-8 flex items-center justify-center gap-8 text-sm text-c400 font-medium">
            ...
            <span className="flex items-center gap-2"><MessageSquare className="w-5 h-5 text-blueL" /> Daily Discussions</span>
          </div>
        </div>
      </section>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="mt-1 shrink-0 w-10 h-10 rounded-full bg-blueL flex items-center justify-center text-blue">
                  <MessageSquare className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="text-xl font-bold text-c900 mb-2">Real Conversations</h4>
                  <p className="text-c600">Ask questions about company culture, interview processes, and career transitions. Get answers from people who actually work there.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-xl font-bold text-c900 mb-2">Build Your Network</h4>
                  <p className="text-c600">Follow industry leaders, connect with peers, and discover mentors. Your network is your net worth.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-xl font-bold text-c900 mb-2">Safe & Supportive</h4>
                  <p className="text-c600">Strict community guidelines ensure that discussions remain professional, helpful, and respectful at all times.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-white py-20 border-t border-c200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-c900 mb-6">Ready to accelerate your career?</h2>
          <p className="text-xl text-c600 mb-10 max-w-2xl mx-auto">
