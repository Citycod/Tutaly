...
export default async function LegalPageDynamic(props: {
  ...
  return (
    <div className="min-h-screen bg-c100 pt-20 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 bg-white shadow-sm rounded-2xl border border-c100 overflow-hidden">
        {/* Header */}
        <div className="px-6 sm:px-10 py-10 border-b border-c100 bg-c100/50 text-center">
          <h1 className="text-3xl font-bold text-c900 mb-2">{pageData.title}</h1>
          <p className="text-c500 text-sm">
